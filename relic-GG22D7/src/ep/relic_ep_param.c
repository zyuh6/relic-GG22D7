...
/**
 * Parameters for the GG22D7-457 pairing-friendly elliptic curve.
 */
/** @{ */
#define GG22D7_P457_A		"-3"
#define GG22D7_P457_B		"171F594BA83F6550F1D59E4CBAB3B75DE24653007243DC3E26BACA2DF5C44CBBD36216A1978B67E2EFFBC4CB65DE0EE39DD4FCA348CF823F00"
#define GG22D7_P457_X		"13F4017AB42D2382663279101DBA3AB3C335E1C60618EBD95C16CBD80619DD22DD2FB4D678BC26F58A10D99A3942C26678B95ACB730CCAECE73"
#define GG22D7_P457_Y		"916631AFFD611C1F568157554089176BF51C11CB1428F951BDED1CB9FE8BFBE32FB1A8F40EC23E9A730B3EAEAE22CA0561F9558A29E00ACD24"
#define GG22D7_P457_R		"544DACE03351E476C00D591F5A370FC93D2C9666C22874C2514C2EE109931EF6C130BB95A1DF04DD7764B0A22F1F0FDD"
#define GG22D7_P457_H		"595C6A243DBE8DE8D08"
/** @} */
#endif
...
#if defined(EP_PLAIN) && FP_PRIME == 457
			case GG22D7_P457:
				ASSIGN(GG22D7_P457, GG22D7_457);
				plain = 1;
				pairf = EP_GG22D7;
				// core_get()->ep_is_pairf = EP_GG22D7;
				break;
#endif
#if defined(EP_ENDOM) && FP_PRIME == 508
			case K18_P508:
...
#elif FP_PRIME == 457
	ep_param_set(GG22D7_P457);
	ep11_curve_set_twist(RLC_EP_DTYPE);
#elif FP_PRIME == 521
...
void ep_param_print(void) {
	switch (ep_param_get()) {
		...
		case CURVE_511187:
			...
			break;
		case GG22D7_P457:
			util_banner("Curve GG22D7_P457:", 0);
			break;
	}
}
