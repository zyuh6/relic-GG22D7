...
int fp11_is_zero(const fp11_t a) {
	return fp_is_zero(a[0]) && fp_is_zero(a[1]) && fp_is_zero(a[2]) && fp_is_zero(a[3]) && fp_is_zero(a[4]) && fp_is_zero(a[5]) && fp_is_zero(a[6]) && fp_is_zero(a[7]) && fp_is_zero(a[8]) && fp_is_zero(a[9]) && fp_is_zero(a[10]);
}
...
int fp22_is_zero(const fp22_t a) {
	return fp11_is_zero(a[0]) && fp11_is_zero(a[1]);
}
