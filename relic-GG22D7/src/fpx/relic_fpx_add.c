...
void fp11_addc_low(dv11_t c, dv11_t a, dv11_t b)
{
	...
	fp_addc_low(c[7],a[7],b[7]);
	fp_addc_low(c[8],a[8],b[8]);
	fp_addc_low(c[9],a[9],b[9]);
	fp_addc_low(c[10],a[10],b[10]);
}
...
void fp11_addd_low(dv11_t c, dv11_t a, dv11_t b)
{
	...
	fp_addd_low(c[7],a[7],b[7]);
	fp_addd_low(c[8],a[8],b[8]);
	fp_addd_low(c[9],a[9],b[9]);
	fp_addd_low(c[10],a[10],b[10]);
}
...
void fp11_subc_low(dv11_t c, dv11_t a, dv11_t b)
{
	...
	fp_subc_low(c[7],a[7],b[7]);
	fp_subc_low(c[8],a[8],b[8]);
	fp_subc_low(c[9],a[9],b[9]);
	fp_subc_low(c[10],a[10],b[10]);
}
...
void fp11_addn_low(fp11_t c, const fp11_t a, const fp11_t b)
{
	...
	fp_addn_low(c[7],a[7],b[7]);
	fp_addn_low(c[8],a[8],b[8]);
	fp_addn_low(c[9],a[9],b[9]);
	fp_addn_low(c[10],a[10],b[10]);
}
...
{
	fp11_add(c[0],a[0],b[0]);
	fp11_add(c[1],a[1],b[1]);
}
...
{
	fp11_sub(c[0],a[0],b[0]);
	fp11_sub(c[1],a[1],b[1]);
}
