...
/**
 * Computes the final exponentiation for a pairing defined over curves of
 * embedding degree 22. Computes c = (a^(p^22 - 1)/r)^s.
 *
 * @param[out] c			- the result.
 * @param[in] a				- the extension field element to exponentiate.
 */
...
/**
 * Computes the optimal ate pairing of two points in a parameterized elliptic
 * curve with embedding degree 22.
 *
 * @param[out] r			- the result.
 * @param[in] Q				- the first elliptic curve point.
 * @param[in] P				- the second elliptic curve point.
 ...
 * curve with embedding degree 22 using 2-isogeny.
 *
 * @param[out] r			- the result.
 * @param[in] Q				- the first elliptic curve point.
 * @param[in] P				- the second elliptic curve point.
...
/**
 * Adds two points and evaluates the corresponding line function at another
 * point on an elliptic curve with embedding degree 22.
 *
 * @param[out] L			- the result of the evaluation.
 * @param[out] RR		        - the resulting point.
...
/**
 * Doubles a point and evaluates the corresponding line function at another
 * point on an elliptic curve with embedding degree 22 in affine coordinates.
 *
 * @param[out] L			- the result of the evaluation.
 * @param[out] RR		        - the resulting point.
 * @param[in] T 		        - the point to double in affine coordinates.
 * @param[in] P				- the affine point to evaluate the line function.
 */
void pp_dbl1_k22(fp22_t L, ep11_t RR, const ep11_t T, const ep_t P);

/**
 * Adds two points and evaluates the corresponding line function at another two
 * points on an elliptic curve with embedding degree 22 using 2-isogeny speedup.
 *
...
/**
 * Doubles a point and evaluates the corresponding line function at another
 * point on an elliptic curve with embedding degree 22 using 2-isogeny speedup.
 *
 * @param[out] L1			- the first result of the evaluation.
 * @param[out] L2			- the second result of the evaluation.
 * @param[out] RR		        - the resulting point.
...
/**
 * Doubles a point in affine coordinates and evaluates the corresponding line function 
 * at another point on an elliptic curve with embedding degree 22 using 2-isogeny speedup.
 *
 * @param[out] L1			- the first result of the evaluation.
 * @param[out] L2			- the second result of the evaluation.
 * @param[out] RR		        - the resulting point.
