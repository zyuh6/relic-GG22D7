...
typedef struct _ctx_t {
	...
	/** The generator of the elliptic curve over Fp^11. */
	ep11_st ep11_g;
	/** The 'a' coefficient of the curve. */
	fp11_t ep11_a;
	/** The 'b' coefficient of the curve. */
	fp11_t ep11_b;
	/** The x-coordinate of the 2-order point on the curve. */
	fp_t ep11_T2;
	/** Optimization identifier for the a-coefficient. */
	int ep11_opt_a;
	/** Optimization identifier for the b-coefficient. */
	...
	int ep11_is_twist;
	/** Precomputation table for generator multiplication.*/
	ep11_st ep11_pre[RLC_EP_TABLE];
	/** Array of pointers to the precomputation table. */
	ep11_st *ep11_ptr[RLC_EP_TABLE];
#endif /* WITH_EPX */
	...
	fp11_t frb11_9b[11];
	fp11_t frb11_10b[11];
	/**  (p+1)/2, p is the prime of GG22-457 */
	fp_t fp11_half;
